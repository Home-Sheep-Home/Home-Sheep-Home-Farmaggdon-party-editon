...
namespace Rewired.Data.Mapping
{
	public class HardwareJoystickMap : ScriptableObject
	{
		...
		{
			[Serializable]
			public class ElementCount_Base
			{
		...
		public class Platform_RawOrDirectInput : Platform
		{
			...
			{
				[Serializable]
				public class ElementCount : HardwareJoystickMap.MatchingCriteria_Base.ElementCount_Base
				{
					public int hatCount;
				}
		...
		[Serializable]
		public class AxisCalibrationInfoEntry
		{
			public AxisCalibrationInfoEntry(HardwareJoystickMap.AxisCalibrationInfoEntry original)
			{
			}
